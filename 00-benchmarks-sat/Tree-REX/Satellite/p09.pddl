...
(:requirements :strips :typing :htn :negative-preconditions)
  ...
  (:goal
        :tasks  (
                    (tag t1  (do_mission Phenomenon5 thermograph8)  )
                    (tag t2  (do_mission Phenomenon5 spectrograph0) )
                    (tag t3  (do_mission Phenomenon5 image3)        )
                    (tag t4  (do_mission Star6 spectrograph0)       ) 
                    (tag t5  (do_mission Star6 spectrograph6)       )
                    (tag t6  (do_mission Star6 image3)              )
                    (tag t7  (do_mission Planet7 spectrograph6)     )
                    (tag t8  (do_mission Planet7 infrared5)         )
                    (tag t9  (do_mission Planet7 image2)            )
                    (tag t10 (do_mission Phenomenon8 spectrograph6) )
                    (tag t11 (do_mission Phenomenon8 infrared5)     )
                    (tag t12 (do_mission Phenomenon8 thermograph7)  )
                    (tag t13 (do_mission Planet9 spectrograph6)     )
                    (tag t14 (do_mission Star10 spectrograph6)      )
                    (tag t15 (do_mission Star11 thermograph7)       )
                    (tag t16 (do_mission Star11 image4)             )
                    (tag t17 (do_mission Star11 image3)             )
                    (tag t18 (do_mission Phenomenon12 image4)       )
                    (tag t19 (do_mission Planet13 infrared5)        )
                    (tag t20 (do_mission Planet13 spectrograph6)    )
                    (tag t21 (do_mission Planet13 image2)           )
                    (tag t22 (do_mission Phenomenon14 thermograph7) )
                    (tag t23 (do_mission Planet15 image3)           )
                    (tag t24 (do_mission Star16 image3)             )
                    (tag t25 (do_mission Star16 image4)             )
                    (tag t26 (do_mission Planet18 infrared9)        )
                    (tag t27 (do_mission Planet18 infrared5)        )
                    (tag t28 (do_mission Planet18 thermograph7)     )
                    (tag t29 (do_mission Phenomenon19 image2)       )
                    (tag t30 (do_mission Phenomenon19 image4)       )
                    (tag t31 (do_mission Star20 spectrograph0)      )
                    (tag t32 (do_mission Phenomenon21 image4)       )
                    (tag t33 (do_mission Phenomenon21 image2)       )
                    (tag t34 (do_mission Phenomenon21 thermograph7) )
                    (tag t35 (do_mission Planet22 image2)           )
                    (tag t36 (do_mission Planet22 spectrograph6)    )
                    (tag t37 (do_mission Star23 image2)             )
                    (tag t38 (do_mission Star23 infrared9)          )
                    (tag t39 (do_mission Star24 spectrograph6)      )
                    (tag t40 (do_mission Star24 infrared5)          )
                    (tag t41 (do_turning satellite1 Phenomenon19)   )
                )
        :constraints(and
                        (after (and 
