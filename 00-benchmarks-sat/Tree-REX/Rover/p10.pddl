...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint8))
					(tag t2 (get_soil_data waypoint23))
					(tag t3 (get_soil_data waypoint7))
					(tag t4 (get_soil_data waypoint11))
					(tag t5 (get_soil_data waypoint13))
					(tag t6 (get_soil_data waypoint20))
     				(tag t7 (get_rock_data waypoint7))
     				(tag t8 (get_rock_data waypoint14))
     				(tag t9 (get_rock_data waypoint22))
     				(tag t10 (get_rock_data waypoint16))
     				(tag t11 (get_rock_data waypoint12))
     				(tag t12 (get_rock_data waypoint10))
     				(tag t13 (get_rock_data waypoint9))
     				(tag t14 (get_rock_data waypoint21))
     				(tag t15 (get_rock_data waypoint18))
    				(tag t16 (get_image_data objective2 high_res))
    				(tag t17 (get_image_data objective0 high_res))
    				(tag t18 (get_image_data objective3 colour))
    				(tag t19 (get_image_data objective7 colour))
    				(tag t20 (get_image_data objective5 high_res))
				)
		:constraints(and
						(after (and 
