...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint0))
     				...
     				(tag t3 (get_rock_data waypoint6))
    				(tag t4 (get_image_data objective2 low_res))
    				(tag t5 (get_image_data objective1 high_res))
    				(tag t6 (get_image_data objective3 low_res))
				)
		:constraints(and
						(after (and 
