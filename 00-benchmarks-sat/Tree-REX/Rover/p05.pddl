...
(:goal
		:tasks	(
					...
					(tag t3 (get_soil_data waypoint4))
     				(tag t4 (get_rock_data waypoint5))
     				(tag t5 (get_rock_data waypoint4))
    				(tag t6 (get_image_data objective0 low_res))
    				(tag t7 (get_image_data objective0 high_res))
    				(tag t8 (get_image_data objective2 low_res))
				)
		:constraints(and
						(after (and 
