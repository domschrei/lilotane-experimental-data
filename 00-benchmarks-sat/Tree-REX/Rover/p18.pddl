...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint16))
					(tag t2 (get_soil_data waypoint11))
					(tag t3 (get_soil_data waypoint24))
					(tag t4 (get_soil_data waypoint46))
					(tag t5 (get_soil_data waypoint1))
					(tag t6 (get_soil_data waypoint39))
					(tag t7 (get_soil_data waypoint10))
					(tag t8 (get_soil_data waypoint31))
					(tag t9 (get_soil_data waypoint45))
					(tag t10 (get_soil_data waypoint18))
					(tag t11 (get_soil_data waypoint49))
					(tag t12 (get_soil_data waypoint41))
					(tag t13 (get_soil_data waypoint25))
     				(tag t14 (get_rock_data waypoint48))
     				(tag t15 (get_rock_data waypoint1))
     				(tag t16 (get_rock_data waypoint2))
     				(tag t17 (get_rock_data waypoint13))
     				(tag t18 (get_rock_data waypoint15))
     				(tag t19 (get_rock_data waypoint43))
    				(tag t20 (get_image_data objective1 high_res))
    				(tag t21 (get_image_data objective6 high_res))
    				(tag t22 (get_image_data objective7 colour))
    				(tag t23 (get_image_data objective5 high_res))
    				(tag t24 (get_image_data objective1 colour))
    				(tag t25 (get_image_data objective1 low_res))
				)
		:constraints(and
						(after (and 
