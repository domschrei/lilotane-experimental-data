...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint21))
					(tag t2 (get_soil_data waypoint34))
					(tag t3 (get_soil_data waypoint26))
					(tag t4 (get_soil_data waypoint22))
					(tag t5 (get_soil_data waypoint27))
					(tag t6 (get_soil_data waypoint5))
					(tag t7 (get_soil_data waypoint9))
     				(tag t8 (get_rock_data waypoint9))
     				(tag t9 (get_rock_data waypoint27))
     				(tag t10 (get_rock_data waypoint15))
     				(tag t11 (get_rock_data waypoint20))
     				(tag t12 (get_rock_data waypoint18))
     				(tag t13 (get_rock_data waypoint2))
    				(tag t14 (get_image_data objective2 high_res))
    				(tag t15 (get_image_data objective6 low_res))
    				(tag t16 (get_image_data objective8 high_res))
    				(tag t17 (get_image_data objective0 colour))
    				(tag t18 (get_image_data objective5 colour))
    				(tag t19 (get_image_data objective0 low_res))
				)
		:constraints(and
						(after (and 
