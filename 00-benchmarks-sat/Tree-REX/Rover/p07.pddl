...
(:goal
		:tasks	(
					...
					(tag t2 (get_soil_data waypoint6))
     				(tag t3 (get_rock_data waypoint5))
     				(tag t4 (get_rock_data waypoint4))
     				(tag t5 (get_rock_data waypoint8))
    				(tag t6 (get_image_data objective0 colour))
    				(tag t7 (get_image_data objective2 low_res))
    				(tag t8 (get_image_data objective0 low_res))
				)
		:constraints(and
						(after (and 
