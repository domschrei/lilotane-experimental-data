...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint24))
					(tag t2 (get_soil_data waypoint2))
					(tag t3 (get_soil_data waypoint1))
					(tag t4 (get_soil_data waypoint12))
					(tag t5 (get_soil_data waypoint11))
					(tag t6 (get_soil_data waypoint21))
					(tag t7 (get_soil_data waypoint3))
					(tag t8 (get_soil_data waypoint25))
     				(tag t9 (get_rock_data waypoint6))
     				(tag t10 (get_rock_data waypoint28))
     				(tag t11 (get_rock_data waypoint20))
    				(tag t12 (get_image_data objective1 low_res))
    				(tag t13 (get_image_data objective5 high_res))
    				(tag t14 (get_image_data objective0 high_res))
				)
		:constraints(and
						(after (and 
