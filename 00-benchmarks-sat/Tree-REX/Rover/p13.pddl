...
(:objects
	...
	rover0_store rover1_store rover2_store rover3_store rover4_store rover5_store 
	
	rover6_store rover7_store - STORE
	
	waypoint0 waypoint1 waypoint2 waypoint3 waypoint4 waypoint5 waypoint6 
	...
	waypoint19 waypoint20 waypoint21 waypoint22 waypoint23 waypoint24 
	waypoint25 waypoint26 waypoint27 waypoint28 waypoint29 - WAYPOINT
	
	camera0 camera1 camera2 camera3 camera4 camera5 camera6 camera7
	camera8 camera9 camera10 - CAMERA
	
	objective0 objective1 objective2 objective3 objective4 objective5 objective6
	objective7 objective8 objective9 - OBJECTIVE
)
...
(:goal
		:tasks	(
					(tag t1 (get_SOIL_DATA WAYPOINT5))
     				(tag t3 (get_SOIL_DATA WAYPOINT13))
    				(tag t4 (get_SOIL_DATA WAYPOINT4))
 					(tag t5 (get_SOIL_DATA WAYPOINT23))
					(tag t6 (get_SOIL_DATA WAYPOINT15))
     				(tag t7 (get_SOIL_DATA WAYPOINT7))
     				(tag t8 (get_SOIL_DATA WAYPOINT20))
    				(tag t9 (get_SOIL_DATA WAYPOINT26))
     				(tag t10 (get_SOIL_DATA WAYPOINT2))
     				(tag t11 (get_ROCK_DATA WAYPOINT27))
     				(tag t12 (get_ROCK_DATA WAYPOINT19))
     				(tag t13 (get_ROCK_DATA WAYPOINT1))
    				(tag t14 (get_ROCK_DATA WAYPOINT3))
    				(tag t15 (get_ROCK_DATA WAYPOINT7))
     				(tag t16 (get_ROCK_DATA WAYPOINT20))
     				(tag t17 (get_ROCK_DATA WAYPOINT22))
     				(tag t18 (get_IMAGE_DATA OBJECTIVE2 LOW_RES))
					(tag t19 (get_IMAGE_DATA OBJECTIVE6 LOW_RES))
				    (tag t20 (get_IMAGE_DATA OBJECTIVE3 LOW_RES))
				   	(tag t21 (get_IMAGE_DATA OBJECTIVE6 COLOUR))
				   	(tag t22 (get_IMAGE_DATA OBJECTIVE3 HIGH_RES))
				    (tag t23 (get_IMAGE_DATA OBJECTIVE1 COLOUR))
				    (tag t24 (get_IMAGE_DATA OBJECTIVE6 HIGH_RES))
				    (tag t25 (get_IMAGE_DATA OBJECTIVE3 COLOUR))
				    (tag t26 (get_IMAGE_DATA OBJECTIVE2 HIGH_RES)) 
