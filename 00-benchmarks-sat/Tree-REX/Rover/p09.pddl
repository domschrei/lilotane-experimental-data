...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint14))
					(tag t2 (get_soil_data waypoint0))
     				(tag t3 (get_rock_data waypoint4))
     				(tag t4 (get_rock_data waypoint7))
     				(tag t5 (get_rock_data waypoint2))
     				(tag t6 (get_rock_data waypoint5))
     				(tag t7 (get_rock_data waypoint6))
    				(tag t8 (get_image_data objective5 colour))
    				(tag t9 (get_image_data objective3 low_res))
    				(tag t10 (get_image_data objective2 colour))
    				(tag t11 (get_image_data objective4 high_res))
				)
		:constraints(and
						(after (and 
