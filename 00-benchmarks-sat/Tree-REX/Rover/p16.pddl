...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint10))
					(tag t2 (get_soil_data waypoint28))
					(tag t3 (get_soil_data waypoint2))
					(tag t4 (get_soil_data waypoint24))
					(tag t5 (get_soil_data waypoint15))
					(tag t6 (get_soil_data waypoint17))
					(tag t7 (get_soil_data waypoint3))
					(tag t8 (get_soil_data waypoint0))
     				(tag t9 (get_rock_data waypoint4))
     				(tag t10 (get_rock_data waypoint17))
     				(tag t11 (get_rock_data waypoint33))
     				(tag t12 (get_rock_data waypoint24))
     				(tag t13 (get_rock_data waypoint27))
     				(tag t14 (get_rock_data waypoint18))
    				(tag t15 (get_image_data objective7 high_res))
    				(tag t16 (get_image_data objective5 low_res))
    				(tag t17 (get_image_data objective4 low_res))
    				(tag t18 (get_image_data objective4 high_res))
    				(tag t19 (get_image_data objective2 low_res))
				)
		:constraints(and
						(after (and 
