...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint23))
					(tag t2 (get_soil_data waypoint0))
					(tag t3 (get_soil_data waypoint14))
					(tag t4 (get_soil_data waypoint34))
					(tag t5 (get_soil_data waypoint18))
					(tag t6 (get_soil_data waypoint16))
					(tag t7 (get_soil_data waypoint12))
					(tag t8 (get_soil_data waypoint6))
     				(tag t9 (get_rock_data waypoint24))
     				(tag t10 (get_rock_data waypoint33))
     				(tag t11 (get_rock_data waypoint9))
    				(tag t12 (get_image_data objective4 high_res))
    				(tag t13 (get_image_data objective3 high_res))
    				(tag t14 (get_image_data objective7 colour))
				)
		:constraints(and
						(after (and 
