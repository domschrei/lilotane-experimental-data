...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint25))
					(tag t2 (get_soil_data waypoint3))
					(tag t3 (get_soil_data waypoint14))
					(tag t4 (get_soil_data waypoint21))
					(tag t5 (get_soil_data waypoint32))
					(tag t6 (get_soil_data waypoint10))
					(tag t7 (get_soil_data waypoint8))
					(tag t8 (get_soil_data waypoint0))
     				(tag t9 (get_rock_data waypoint32))
     				(tag t10 (get_rock_data waypoint29))
     				(tag t11 (get_rock_data waypoint28))
     				(tag t12 (get_rock_data waypoint11))
     				(tag t13 (get_rock_data waypoint10))
     				(tag t14 (get_rock_data waypoint9))
     				(tag t15 (get_rock_data waypoint4))
     				(tag t16 (get_rock_data waypoint26))
    				(tag t17 (get_image_data objective7 colour))
    				(tag t18 (get_image_data objective5 high_res))
    				(tag t19 (get_image_data objective5 colour))
    				(tag t20 (get_image_data objective0 high_res))
				)
		:constraints(and
						(after (and 
