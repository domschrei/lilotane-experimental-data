...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint4))
					(tag t2 (get_soil_data waypoint9))
					(tag t3 (get_soil_data waypoint1))
					(tag t4 (get_soil_data waypoint7))
     				(tag t5 (get_rock_data waypoint3))
     				(tag t6 (get_rock_data waypoint10))
     				(tag t7 (get_rock_data waypoint5))
     				(tag t8 (get_rock_data waypoint1))
    				(tag t9 (get_image_data objective0 high_res))
    				(tag t10 (get_image_data objective4 high_res))
    				(tag t11 (get_image_data objective2 high_res))
				)
		:constraints(and
						(after (and 
