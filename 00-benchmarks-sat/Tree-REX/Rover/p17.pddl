...
(:goal
		:tasks	(
					(tag t1 (get_soil_data waypoint9))
					(tag t2 (get_soil_data waypoint14))
					(tag t3 (get_soil_data waypoint28))
					(tag t4 (get_soil_data waypoint2))
					(tag t5 (get_soil_data waypoint23))
					(tag t6 (get_soil_data waypoint26))
     				(tag t7 (get_rock_data waypoint23))
     				(tag t8 (get_rock_data waypoint18))
     				(tag t9 (get_rock_data waypoint11))
     				(tag t10 (get_rock_data waypoint36))
    				(tag t11 (get_image_data objective5 high_res))
    				(tag t12 (get_image_data objective3 colour))
    				(tag t13 (get_image_data objective5 low_res))
    				(tag t14 (get_image_data objective3 high_res))
    				(tag t15 (get_image_data objective1 high_res))
    				(tag t16 (get_image_data objective7 colour))
				)
		:constraints(and
						(after (and 
